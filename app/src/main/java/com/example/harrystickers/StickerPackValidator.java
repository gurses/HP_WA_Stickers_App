...
class StickerPackValidator {
    private static final int STICKER_FILE_SIZE_LIMIT_KB = 10 * 1024;
    private static final int EMOJI_LIMIT = 3;
    private static final int IMAGE_HEIGHT = 512;
    private static final int IMAGE_WIDTH = 512;
    private static final int STICKER_SIZE_MIN = 1;
    private static final int STICKER_SIZE_MAX = 900;
    private static final int CHAR_COUNT_MAX = 528;
    private static final long ONE_KIBIBYTE = 10 * 1024;
    private static final int TRAY_IMAGE_FILE_SIZE_MAX_KB = 900;
